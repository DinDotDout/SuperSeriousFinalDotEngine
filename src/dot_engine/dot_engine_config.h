...
enum
{
    ...
    ENGINE_RENDERER_TRANSIENT_MEM_SIZE = DOT_MB(20),
...
#   endif
    ...
    THREAD_TEMP_ARENA_SIZE  = DOT_MB(40),

    GAME_PERMANENT_MEMORY_SIZE = DOT_MB(20),
    GAME_TRANSIENT_MEMORY_SIZE = DOT_KB(32),

    APPLICATION_MEMORY_SIZE = DOT_MB(30) +
        (THREAD_TEMP_ARENA_SIZE * THREAD_TEMP_ARENA_COUNT * THREAD_COUNT) + 
        ENGINE_RENDERER_PERMANENT_MEM_SIZE +
