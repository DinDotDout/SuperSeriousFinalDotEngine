...
enum
{
    ...
    ENGINE_RENDERER_BACKEND_MEM_SIZE            = ENGINE_RENDERER_BACKEND_TRANSIENT_MEM_SIZE + KB(512),

    ENGINE_RENDERER_TRANSIENT_MEM_SIZE = MB(1),
    ENGINE_RENDERER_PERMANENT_MEM_SIZE = MB(1) + ENGINE_RENDERER_TRANSIENT_MEM_SIZE +
...
#   endif
    ...
    APPLICATION_MEMORY_SIZE = MB(30) + ENGINE_RENDERER_PERMANENT_MEM_SIZE +
